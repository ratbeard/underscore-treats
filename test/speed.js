(function() {
  ...
  JSLitmus.test('_.reduceHash()', function() {
    return _.reduceHash([11, 22, 33], function(hash, num, i){ 
      hash[num] = i; 
    });
  });
  JSLitmus.test('_.reduce()', function() {
    return _.reduce([11, 22, 33], {}, function(hash, num, i){ 
      hash[num] = i;
      return hash;
    });
  });
